...
void setup() {
  Serial.begin(115200);
  Serial.println("MaxIQ Model Rocket Test Stand");
  // EEPROM.begin(20);
...
void loop() {
  if (myScale.available() == true) {
    ...
    // Serial.print("\tForce: ");
    float force = currentWeight / 101.972;
    if (force > 0.05) {
      // Serial.print(millis() - resetClock);
      // Serial.print(",");
      Serial.println(currentWeight / 101.972, 2);
    }  //Print 2 decimal places - gram to Newton
    else {
      resetClock = millis();
    }
